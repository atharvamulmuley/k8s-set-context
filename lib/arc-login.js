...
function getArcKubeconfig() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield az_login.executeAzCliCommand(`login --service-principal --username ${servicePrincipalId} --password ${servicePrincipalKey} --tenant ${tenantId}`, false);
            ...
            yield sleep(240000) //sleeping for a minute to allow kubeconfig to be merged
